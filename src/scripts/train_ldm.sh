...
accelerate launch --mixed_precision="fp16" src/train_online_ldm.py \
    ...
    --sub_datasets ucsd_pick_and_place_dataset_converted_externally_to_rlds \
    ...
    --checkpointing_steps=5 --checkpoints_total_limit=1 \
    --learning_rate=5e-05 --max_grad_norm=1 --lr_warmup_steps=0 \
    --conditioning_dropout_prob=0.05 \
    --mixed_precision=fp16 \
    --seed=42 \
    --output_dir="experiments/ldm-test" \
    --report_to=wandb 
...
accelerate launch --mixed_precision="fp16" --multi_gpu src/train_online_ldm.py \
    ...
    --mixed_precision=fp16 \
    --seed=42 \
    --output_dir="experiments/ldm-test-multi-gpu" \
    --report_to=wandb 
